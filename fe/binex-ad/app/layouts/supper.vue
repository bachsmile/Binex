...
const currentPathName = computed(() => {
  if (route.path.endsWith('/users')) return 'Người dùng';
  return 'Dashboard';
});
    ...
    <div class="flex-1 flex flex-col min-w-0 transition-all duration-300 h-full overflow-hidden">
      ...
      <header class="h-16 px-6 md:px-8 border-b border-zinc-150/80 dark:border-zinc-900 bg-white/80 dark:bg-zinc-955/80 backdrop-blur-md flex items-center justify-between shrink-0 select-none z-10">
        ...
        <div class="flex items-center gap-4">
          <div class="hidden sm:flex items-center gap-2 text-xs font-semibold text-zinc-400 dark:text-zinc-550">
            <span>Pages</span>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="hidden md:flex flex-col text-left">
              ...
              <span class="text-[10px] text-zinc-400 dark:text-zinc-550 font-bold uppercase tracking-wider leading-none mt-0.5">Super Admin</span>
            </div>
          </div>
        </div>
      </header>
